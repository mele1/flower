...
If (empty ($name))
{
	echo" <p><Font color='Red'> Please enter name </Font></p>";}
	
	$email =$_REQUEST['email'];
If (empty ($email))
{
	echo" <p><Font color='Red'> Please enter Email </Font></p>";
	}
...
If (empty ($message))
{
	...
	mysql_select_db("mix",$conn) or die ('error');
	
	$strSQL ="Insert into feedback (name,email,message)
